...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["submit"])) {
        ...
        $insertQuery = "INSERT INTO klinik (nama, jenis, alamat, latitude, longtitude) 
                        VALUES ('$nama', '$jenis', '$alamat', '$latitude', '$longtitude')";
        ...
        $updateQuery = "UPDATE klinik SET nama='$nama', jenis='$jenis', alamat='$alamat', latitude='$latitude', longtitude='$longtitude' WHERE no=$editNo";
...
// Query untuk mengambil data klinik setelah data ditambahkan
                ...
                <div class="container mt-1 p-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-8 d-flex">
                            <button type="button" class="btn btn-success me-2" data-bs-toggle="modal" data-bs-target="#addKlinikModal">Tambah</button>
                            <div class="dropdown">
                    ...
                    <!-- Modal for Add Klinik -->
                    <div class="modal fade" id="addKlinikModal" tabindex="-1" aria-labelledby="addKlinikModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="addKlinikModalLabel">Tambah Klinik</h5>
                   ...
                   <!-- Modal for Edit Klinik -->
                    <div class="modal fade" id="editKlinikModal" tabindex="-1" aria-labelledby="editKlinikModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="editKlinikModalLabel">Edit Klinik</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form action="" method="post">
                    ...
                    <div class="table-responsive">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="action-icons">
                                            <button class="btn btn-sm btn-warning" onclick="openEditModal(<?php echo $baris['no']; ?>, '<?php echo $baris['nama']; ?>', '<?php echo $baris['jenis']; ?>', '<?php echo $baris['alamat']; ?>', '<?php echo $baris['latitude']; ?>', '<?php echo $baris['longtitude']; ?>')">
                                                <i class="bi bi-pencil-square"></i>
                                            </button>
                                            <a href="delete_klinik.php?no=<?php echo $baris['no']; ?>" onClick="return confirm('Yakin?')" class="btn btn-danger btn-sm">
                        ...
                        <script>
                            ...
                            function openEditModal(no, nama, jenis, alamat, latitude, longtitude) {
                                ...
                                // Show the edit modal
                                var editModal = new bootstrap.Modal(document.getElementById('editKlinikModal'));
                                editModal.show();
                            }
